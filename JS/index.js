...
(function MaxPassengersCapacity() {
    let planes = [
    ...
    militaryAirport = militaryAirport.sortByMaxDistance();
    passengerAirport = passengerAirport.sortByMaxSpeed();
    passengerAirport = passengerAirport.getPassengerPlaneWithMaxPassengersCapacity();
})();